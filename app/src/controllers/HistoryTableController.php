...
final class HistoryTableController extends BaseController
{
    ...
    public function historytable(Request $request, Response $response, $args)
    {
        $this->view->render($response, 'historytable.twig');
        return $response;
    }
